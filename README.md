...
Para aqueles que não tem docker instalado em sua maquina faça o seguinte tutorial <a href='https://docs.docker.com/desktop/setup/install/windows-install/'> Windows </a> ou <a href='https://docs.docker.com/engine/install/'> Linux </a>
